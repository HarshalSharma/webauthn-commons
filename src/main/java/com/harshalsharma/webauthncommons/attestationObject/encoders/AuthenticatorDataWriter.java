//package com.harshalsharma.webauthncommons.attestationObject.encoders;
//
//import com.harshalsharma.webauthncommons.attestationObject.parsers.AttestedCredentialDataReader;
...
// */
//public class AuthenticatorDataWriter {
//
...
//
//    public static String writeAsCbor(AuthenticatorData authData) {
//        List<Byte> output = new ArrayList<>();
//        byte[] rpIdHashBytes = authData.getRpIdHash();
//        for (byte rpIdHashByte : rpIdHashBytes) {
//            output.add(rpIdHashByte);
//        }
//        byte flags = authData.getFlags();
//        output.add(flags);
//        output.add(Integer.valueOf(authData.getSignCount()).byteValue());
//
